...
def test_space_state_updater_1():
    ...
    initial_point = point
    dt = 0.0
    point = space_state_updater(point, 0.0, 1.0, dt, 0.0, 1.0)
...
def test_run_simulation_2():
    ...
    passed to the numpy default_rng inside the simulation body. The simulation
    is called two times with the same inputs and stored in two different lists.
    The test checks that the lists have the same elements.
    '''
